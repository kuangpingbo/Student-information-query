...
-->
    ...
    <body>
    <div id="container"><div id="header"><a href="http://tieba.baidu.com/home/main?un=%E4%B8%80%E7%94%9F%E5%8F%AA%E7%88%B1%E4%B8%89%E6%9C%88%E8%8A%B1&ie=utf-8&fr=frs" ><h1>郴州高职院学生信息查询</h1></a></div><br /><br />
<form name="from" action="index.php" method="post">
    ...
    <p class="ali"><label for="alias">输入关键字:</label><span>班级，名字，身份证信息...</span></p>
  ...
  <?php
       if(isset($count))
       {
         ...
         echo '<br /><br /><font color=#666666><li>学籍号-班级-学号-姓名-性别-身份证号<br /></li></font>';
         echo '</ul>';
            }
         echo '</ul>';
         }
...
<div id="footer">
<p>Social Engineering Data &copy;2010-2013 Powered By <a href="#" target="_blank">JKS_欢迎您<a></p><div style="display:none">
</div>-->
</div>
</body>
</html>